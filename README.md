...
$$ 0 = 3 a x_0^2 + 2 b x_0 + c \hspace{1.7cm} ...(3) \quad Gradient \hspace{2mm} of \hspace{2mm} f_x \hspace{2mm} is \hspace{2mm} zero \hspace{2mm} at \hspace{2mm} p_0. \hspace{2mm} f'(x_0) = 0 $$

$$ 0 = 3 a x_1^2 + 2 b x_1 + c \hspace{1.7cm} ...(4) \quad Gradient \hspace{2mm} of \hspace{2mm} f_x \hspace{2mm} is \hspace{2mm} zero \hspace{2mm} at \hspace{2mm} p_1. \hspace{2mm} f'(x_1) = 0 $$
...
$$ b = \dfrac{ 3 x_0 y_0 - 3 x_0 y_1 + 3 x_1 y_0 - 3 x_1 y_1 }{ x_0^3 - 3 x_1 x_0^2 + 3 x_0 x_1^2 - x_1^3 } \hspace{0.3cm}$$
...
$$ 0 \leq t_0 \leq t_1 \quad \quad ...p_0 \hspace{2mm} comes \hspace{2mm} before \hspace{2mm} p_1. \hspace{3.6cm} $$
